...
$stuList = $this->certificate_printed_list();
?>


<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 mb-3 border-bottom">
    <div>
        <h1 class="h2 d-inline mr-2">Student List of Printed Certificated</h1>
        ...
        <?php foreach ($stuList as $item): ?>
            <tr class="align-middle<?= ($item->result_status == 'Failed') ? " table-danger" : "" ?>">
                ...
                <td class="text-center">
                    ...
                    <span class="badge <?= $printed ? "badge-danger" : "badge-success" ?> mb-2"><?= 'Printed: ' . Tools::short_date($item->last_printed) ?></span> <br>
